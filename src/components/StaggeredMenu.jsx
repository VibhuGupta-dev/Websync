...
// CSS inline as a style tag to avoid separate file
const StaggeredMenuStyles = () => (
  <style>{`
    ...
    .sm-socials-link {
      ...
      text-decoration: none; position: relative; padding: 2px 0;
      display: inline-block;
    ...
    .sm-panel-item {
      ...
      font-size: 3.5rem; cursor: pointer; line-height: 1;
    ...
    .sm-panel-list[data-numbering] .sm-panel-item::after {
      ...
      position: absolute; top: 0.1em; right: 2.8em;
      font-size: 18px; font-weight: 400;
      color: var(--sm-accent, #5227ff); letter-spacing: 0;
...
export const StaggeredMenu = ({
  ...
  onMenuOpen,
  onMenuClose,
  // Custom render props for UpperNavbar integration
  customToggle,
}) => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Custom toggle — exposed so UpperNavbar can trigger it */}
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
          ...
          onClick={toggleMenu}
          type="button"
          style={{ display: 'none' }} // hidden — UpperNavbar renders its own trigger
        >
...
{customToggle && customToggle({ toggle: toggleMenu, open, close: closeMenu })}
      </div>
    </>
  );
};
